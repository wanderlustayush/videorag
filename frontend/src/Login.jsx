  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* INNER WRAPPER — controls max width and left-aligns text */}
        <div style={{
          width: "100%",
          maxWidth: 420,
          display: "flex",
          flexDirection: "column",
          alignItems: "flex-start",  // ← text left-aligned inside centered block
        }}>
          ...
          <h1 style={{
            ...
            Upload fast,<br />Learn faster
          </h1>

          <p style={{ color: "#aaa", fontSize: 15, marginBottom: 24 }}>
            Sign in to start  <span style={{ color: "#fff" }}>Smart Learning</span>
          </p>
          ...
          <div style={{
            ...
            <div style={{ textAlign: "center", color: "#555", marginBottom: 14, fontSize: 13 }}>
              OR
            </div>
            ...
            <button
              ...
              style={{
                ...
                fontFamily: "'Noto Serif Display', serif",fontWeight: 600, cursor: "pointer", fontSize: 17
              }}
            >
            ...
            <p style={{ marginTop: 14, fontSize: 13, color: "#666", textAlign: "center" }}>
              ...
              <span onClick={() => navigate("/signup")} style={{ color: "#fff", cursor: "pointer" }}>
                Sign up
              </span>
            </p>
          </div>
